...
$out_mono = sprintf("%s%s%s", "um_spm_", $my_date, ".tsv");
$out_multi = sprintf("%s%s%s", "um_mpm_", $my_date, ".tsv");
$out_ser = sprintf("%s%s%s", "um_serials_", $my_date, ".tsv");
$out_log = sprintf("%s%s%s", "um_log_", $my_date, ".txt");
